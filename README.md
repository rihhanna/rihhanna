...
<img src="https://readme-typing-svg.herokuapp.com/?font=Righteous&size=42&center=true&vCenter=true&width=950&height=70&duration=4000&lines=Hi+👋,+I'm+Rehana+Hassan+Muhumed;Software+Engineer+%7C+Data+Analyst;Machine+Learning+%26+AI+Enthusiast;Turning+Data+Into+Intelligent+Solutions;Building+Solutions+That+Matter&color=FFD700" />
...
<img src="https://img.shields.io/badge/Machine%20Learning%20%26%20AI-FFD700?style=for-the-badge&logo=openai&logoColor=black" />
...
Alhamdulillah, 2026 has been one of the most impactful years of my learning journey. Within the first five months, I achieved several important milestones:

## 🎓 Certifications & Learning

✅ Completed **Machine Learning Specialization by DeepLearning.AI (Coursera)**
...
✅ Completed **6-Week Data Analytics Internship at Afynix Digital**
...
📈 Data Visualization  
🗄️ SQL Analytics  
📢 Marketing Campaign Analysis Capstone Project  

Technologies used:
Python | Pandas | SQL | Matplotlib | Seaborn | Jupyter Notebook

---

## 🤖 Machine Learning Projects Completed

Built and documented multiple Machine Learning projects:
...
From learning the foundations of Data Analytics to completing Machine Learning Specialization, I continue building my path toward becoming an **AI & Machine Learning Specialist**.

Alhamdulillah, every achievement represents consistency, dedication, and continuous learning.
...
|---------|-------------|--------------|
| 🏠 House Price Prediction | Predicting house prices using regression techniques | Python, Pandas, Scikit-Learn |
| 🎓 Student Performance Prediction | Predicting student outcomes using Machine Learning | Python, Logistic Regression |
| 🤖 Pass/Fail Classification | Classification model for predicting academic success | Python, ML Algorithms |
| 📢 Marketing Campaign Analysis | Customer behavior and campaign performance analysis | Python, Pandas, Visualization |
| 📊 Customer Segmentation Dashboard | RFM analysis and customer insights dashboard | Dash, Plotly |
| 📈 Churn Analysis Dashboard | Business intelligence dashboard for customer retention | Power BI, SQL |
| 📚 Online Bookstore | Full-stack web application | ASP.NET, SQL Server |
| 🌱 Crop IQ | Smart agriculture recommendation system | Python, Machine Learning, Django |
---
...
- ✅ Complete Data Analytics Internship
- ✅ Build multiple Machine Learning projects
- 🚀 Develop advanced AI solutions
- 🤖 Continue learning Deep Learning
- ☁️ Explore Cloud AI & MLOps
- 🌐 Contribute to open-source projects
- 💼 Start a professional career in Data & AI
---
...
<img src="https://raw.githubusercontent.com/rihhanna/rihhanna/output/github-contribution-grid-snake-dark.svg" />
...
🧕 **Rehana  Hassan Muhumed(Rai Noir)**  
